...
<!-- ===================== HEADER / NAVBAR ===================== -->
<!--
    FILE: src/main/webapp/trangchu.jsp
    CSS:  src/main/webapp/css/trangchu.css
    CLASS: .navbar
        ├── .navbar__logo          → Logo trái
        ├── .navbar__menu          → Danh sách nav (ul)
        │     └── .navbar__item   → Từng li
        │           └── .navbar__link  → a thường
        ├── .navbar__check-btn     → Nút "Kiểm tra tour" (form submit)
        ├── .navbar__auth          → Khu vực đăng nhập / chào mừng
        │     ├── .navbar__welcome → Chào mừng username
        │     ├── .navbar__logout  → Nút đăng xuất
        │     └── .navbar__login   → Nút đăng nhập
        └── .navbar__toggle        → Hamburger icon (mobile)
-->
<header class="navbar">
    ...
    <nav class="navbar__nav" id="mainNav" aria-label="Menu chính">
        <ul class="navbar__menu">
            <li class="navbar__item"><a class="navbar__link active" href="trangchu.jsp">Trang chủ</a></li>
            <li class="navbar__item"><a class="navbar__link" href="gioiThieu.jsp">Giới thiệu</a></li>
            <li class="navbar__item"><a class="navbar__link" href="tour.jsp">Tour</a></li>
            <li class="navbar__item"><a class="navbar__link" href="kinhNghiem.jsp">Kinh nghiệm</a></li>
            <li class="navbar__item"><a class="navbar__link" href="lienHe.jsp">Liên hệ</a></li>
        </ul>
...
<!--
    CLASS: .hero
        ├── .hero__track           → Dải ảnh chạy (animation)
        │     └── .hero__slide     → Từng ảnh + overlay text
        │           ├── .hero__img        → <img>
        │           └── .hero__caption    → Text nổi trên ảnh
        └── .hero__dots            → Dots điều hướng slide
-->
<section class="hero" aria-label="Ảnh bìa điểm đến">
    ...
    <div class="hero__dots" id="heroDots" role="tablist" aria-label="Điều hướng slider"></div>
</section>

<!-- ===================== WHY US ===================== -->
<!--
    CLASS: .whyus
        ├── .section-label         → Tag nhỏ trên tiêu đề ("Về chúng tôi")
        ├── .section-title         → Tiêu đề section
        ├── .whyus__grid           → Grid 2 cột (text + ảnh)
        │     ├── .whyus__text     → Cột trái: mô tả + features
        │     │     ├── .whyus__desc     → Đoạn giới thiệu
        │     │     └── .whyus__features → ul features
        │     │           └── .whyus__feature  → Từng li (icon + text)
        │     └── .whyus__visual   → Cột phải: ảnh tổng quan
        │           └── .whyus__badge    → Badge nổi trên ảnh
-->
    ...
    <div class="container">
        ...
        <div class="whyus__grid">
            <div class="whyus__text">
                <p class="whyus__desc">
                    Hơn <strong>16 năm</strong> tổ chức tour du lịch trong nước, chúng tôi cam kết mang đến
                    hành trình tuyệt vời nhất với dịch vụ chuyên nghiệp, an toàn và đáng tin cậy.
                </p>
                <ul class="whyus__features">
                    ...
                    <li class="whyus__feature">
                        ...
                        <div>
                            ...
                            <p>Hệ thống khách sạn 3–5 sao được kiểm định kỹ lưỡng</p>
                        </div>
                    </li>
                    <li class="whyus__feature">
                        <span class="whyus__icon"><i class="fa fa-shield-halved"></i></span>
                        <div>
                            <strong>Bảo mật thông tin</strong>
                            <p>Dữ liệu khách hàng được mã hóa AES-256, hợp đồng có chữ ký số</p>
                        </div>
                    </li>
                    <li class="whyus__feature">
...
<!--
    CLASS: .destinations
        ├── .section-label
        ├── .section-title
        └── .destinations__grid    → CSS Grid bất quy tắc (mosaic)
              ├── .dest-card       → Từng card ảnh điểm đến
              │     ├── .dest-card--large   → Card to (Đà Lạt, chiếm 2 cột)
              │     └── (không có modifier) → Card thường
              │     Mỗi card có:
              │     ├── <img>              → Ảnh nền
              │     └── .dest-card__info   → Text nổi dưới ảnh
              │           ├── .dest-card__name  → Tên địa điểm
              │           └── .dest-card__sub   → Mô tả ngắn
-->
...
<!--
    CLASS: .featured-tours
        ├── .section-label
        ├── .section-title
        ├── .tour-grid             → Grid 3 cột (tự wrap)
        │     └── .tour-card       → Từng card tour
        │           ├── .tour-card__img-wrap   → Bọc ảnh (relative, overflow hidden)
        │           │     ├── <img class="tour-card__img">
        │           │     └── .tour-card__badge  → Badge "HOT" / "MỚI"
        │           └── .tour-card__body        → Nội dung bên dưới ảnh
        │                 ├── .tour-card__name   → Tên tour (a)
        │                 ├── .tour-card__meta   → Thông tin (thời gian, lịch)
        │                 │     └── .tour-card__meta-item  → Từng dòng meta
        │                 ├── .tour-card__price  → Giá tour
        │                 └── .tour-card__cta    → Nút "Xem chi tiết" (a)
-->
<section class="featured-tours section">
    <div class="container">
        ...
        <div class="section-more">
            <a href="tour.jsp" class="btn btn--primary">Xem tất cả tour <i class="fa fa-arrow-right"></i></a>
        </div>
    </div>
</section>
...
<!--
    CLASS: .travel-tips
        ├── .section-label
        ├── .section-title
        └── .tips-grid             → Grid: 1 card lớn + 3 card nhỏ
              ├── .tip-card--featured  → Card lớn (Tây Bắc)
              │     ├── .tip-card__img      → <img>
              │     ├── .tip-card__date     → Ngày đăng
              │     ├── .tip-card__title    → Tiêu đề (a)
              │     └── .tip-card__excerpt  → Đoạn tóm tắt
              └── .tips-sidebar        → Cột nhỏ bên phải
                    └── .tip-card--mini   → Card nhỏ (ngang: ảnh + text)
                          ├── .tip-card__img-sm  → Ảnh nhỏ
                          └── .tip-card__content → Text
                                ├── .tip-card__date
                                └── .tip-card__title (a)
-->
        ...
        <div class="tips-grid">
            <div class="tip-card tip-card--featured">
                ...
                <p class="tip-card__excerpt">
                    Tôi vừa kết thúc chuyến du lịch Mộc Châu trong 5 ngày và đang rất háo hức
                    chia sẻ lại những kỉ niệm đẹp trong chuyến đi đó...
                </p>
                <a href="tay_bac.jsp" class="tip-card__more">Đọc thêm <i class="fa fa-arrow-right"></i></a>
            </div>

            <aside class="tips-sidebar">
                <div class="tip-card tip-card--mini">
                    <img class="tip-card__img-sm" src="img/kinhNghiemDL.jpg" alt="Đà Lạt">
                    <div class="tip-card__content">
                        <span class="tip-card__date">02/11/2019</span>
                        <a href="da_lat.jsp" class="tip-card__title">Kinh nghiệm Đà Lạt mùa đông</a>
                        <p>Tôi vừa kết thúc chuyến du lịch Đà Lạt trong 5 ngày...</p>
                    </div>
                </div>
                <div class="tip-card tip-card--mini">
                    <img class="tip-card__img-sm" src="img/kinhNghiemSP.jpg" alt="Sapa">
                    <div class="tip-card__content">
                        <span class="tip-card__date">02/11/2019</span>
                        <a href="sapa.jsp" class="tip-card__title">Kinh nghiệm du lịch tự túc Sapa</a>
                        <p>Tôi vừa kết thúc chuyến du lịch Sapa trong 5 ngày...</p>
                    </div>
                </div>
                <div class="tip-card tip-card--mini">
                    <img class="tip-card__img-sm" src="img/kinhNghiemVH.jpg" alt="Vĩnh Hy">
                    <div class="tip-card__content">
                        <span class="tip-card__date">02/11/2019</span>
                        <a href="vinh_hy.jsp" class="tip-card__title">Kinh nghiệm Vĩnh Hy mùa xuân</a>
...
<!--
    CLASS: .footer
        ├── .footer__top           → Khu vực chứa 3 cột thông tin
        │     ├── .footer__col     → Từng cột (dùng chung class)
        │     │     ├── .footer__heading     → Tiêu đề cột
        │     │     ├── .footer__company     → Tên công ty (cột 1)
        │     │     ├── .footer__address     → Địa chỉ
        │     │     ├── .footer__phone       → Số điện thoại
        │     │     ├── .footer__email       → Email (a)
        │     │     ├── .footer__hotline     → Hotline (cột 2)
        │     │     ├── .footer__socials     → Wrapper icon mạng xã hội
        │     │     │     └── .footer__social-link  → Từng icon (a)
        │     │     └── .footer__links       → Danh sách link (cột 3)
        │     │           └── .footer__link  → Từng a
        └── .footer__bottom        → Dòng bản quyền
              └── .footer__copy    → Text bản quyền
-->
<footer class="footer">
    <div class="container">
