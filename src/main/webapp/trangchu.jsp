                   ...
                   connect-src 'self';">
                            ...
                            <body>
                                <header class="navbar">
                                    ...
                                    <nav class="navbar__nav" id="mainNav" aria-label="Menu chính">
                                        <ul class="navbar__menu">
                                            ...
                                            <li class="navbar__item"><a class="navbar__link" href="gioiThieu.jsp">Giới
                                                    thiệu</a></li>
                                            <li class="navbar__item"><a class="navbar__link" href="tour.jsp">Tour</a>
                                            </li>
                                            <li class="navbar__item"><a class="navbar__link" href="kinhNghiem.jsp">Kinh
                                                    nghiệm</a></li>
                                ...
                                <section class="hero" aria-label="Ảnh bìa điểm đến">
                                    ...
                                    <div class="hero__dots" id="heroDots" role="tablist" aria-label="Điều hướng slider">
                                    </div>
                                </section>
                                            ...
                                            <div class="footer__col">
                                                ...
                                                <div class="footer__socials">
                                                    ...
                                                    <a href="https://www.tiktok.com" class="footer__social-link"
                                                        aria-label="TikTok" rel="noopener noreferrer" target="_blank">
