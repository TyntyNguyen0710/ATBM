                                ...
                                <div class="contact__info">
                                    ...
                                    <div class="contact__socials">
                                        <a href="https://www.facebook.com"
                                            class="footer__social-link footer__social-link--light" aria-label="Facebook"
                                            rel="noopener noreferrer" target="_blank">
                                            <i class="fa-brands fa-facebook"></i>
                                        </a>
                                        <a href="https://www.instagram.com"
                                            class="footer__social-link footer__social-link--light"
                                            aria-label="Instagram" rel="noopener noreferrer" target="_blank">
                                            <i class="fa-brands fa-instagram"></i>
                                        </a>
                                        <a href="mailto:travelgo@gmail.com"
                                            class="footer__social-link footer__social-link--light" aria-label="Email">
                                            <i class="fa fa-envelope"></i>
                                        </a>
                                        <a href="https://www.tiktok.com"
                                            class="footer__social-link footer__social-link--light" aria-label="TikTok"
                                            rel="noopener noreferrer" target="_blank">
                                    ...
                                    <form class="contact-form" action="contact" method="post" novalidate>
                                        ...
                                        <div class="contact-form__row">
                                            <div class="contact-form__group">
                                                <label class="contact-form__label" for="cf-name">Họ và tên
                                                    <span>*</span></label>
                                                <input class="contact-form__input" type="text" id="cf-name"
                                                    name="fullName" placeholder="Nguyễn Văn A" required maxlength="100">
                                            </div>
                                            <div class="contact-form__group">
                                                <label class="contact-form__label" for="cf-phone">Số điện thoại
                                                    <span>*</span></label>
                                                <input class="contact-form__input" type="tel" id="cf-phone" name="phone"
                                                    placeholder="09xxxxxxxx" required pattern="[0-9]{9,11}"
                                                    maxlength="11">
                                            </div>
                                        </div>

                                        <div class="contact-form__group">
                                            <label class="contact-form__label" for="cf-email">Email
                                                <span>*</span></label>
                                        ...
                                        <div class="contact-form__group">
                                            <label class="contact-form__label" for="cf-message">Nội dung
                                                <span>*</span></label>
                                            <textarea class="contact-form__input contact-form__textarea" id="cf-message"
                                                name="message" rows="5" placeholder="Bạn cần hỗ trợ gì..." required
                                                maxlength="2000"></textarea>
                                        </div>

                                        <p class="contact-form__note">
                                            <i class="fa fa-lock"></i>
                                            Thông tin liên hệ của bạn được mã hóa khi truyền tải và chỉ dùng để phản hồi
                                            yêu cầu này.
                                        </p>
                    ...
                    <section class="contact-map">
                        <div class="contact-map__frame">
                            <iframe
                                ...
                                referrerpolicy="no-referrer-when-downgrade" title="Bản đồ vị trí Travel Go"></iframe>
                        </div>
                    </section>
